...
- (void)viewDidLoad
{
    ...
    NSError *error;
    self.items = [[MHCoreDataContext getInstance].managedObjectContext executeFetchRequest:fetchRequest error:&error];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    MHItem *item = [items objectAtIndex:indexPath.row];
